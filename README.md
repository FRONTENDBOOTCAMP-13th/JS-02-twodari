...
|                                       **최동환**<br>스크럼 마스터                                       |                                           **정유진**<br>팀원                                            |                                           **김지연**<br>팀원                                            |                                           **남상호**<br>팀원                                            |
| :-----------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: |
...
|                                          UI & East Room                                           |                                          UI & West Room                                           |                                            Start & South Room                                            |                                         Start & End & North Room                                          |
...
- 아이템 아이콘을 눌러 아이템창을 열 수 있습니다.
  - 아이템 선택 후 사용 버튼을 누르면 초록색 외곽선이 생기고, 그 상태에서 원하는 오브젝트와 상호작용 할 수 있습니다.
